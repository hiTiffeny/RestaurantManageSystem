...
<body>
	...
	<div class="container ">
		<div class="row">
			<div class="col-md-2">
				<ul class="list-group">
					<a href="tradeServlet?method=toTradeUI" class="list-group-item active">未完成订单</a>
					<a href="tradeServlet?method=toTradeAllUI" class="list-group-item">所有订单</a>
				</ul>
			</div>
			<div class="col-md-10">
							...
							<c:forEach items="${page.list }" var="trade">
								...
								<tr>
									...
									<td>
										...
										<a
										href="tradeServlet?method=getTrade&pageNum=${page.pageNo}&tradeId=${trade.id }"
						...
						<nav class="text-center">
							<ul class="pagination">
								<li class=" ${page.hasPrev == true?"":"disabled"}"><a
									href="tradeServlet?method=toTradeUI&pageNo=1"> <span
										aria-hidden="true">首页</span> </a></li>

								<li class=" ${page.hasPrev == true?"":"disabled"}"><a
									href="tradeServlet?method=toTradeUI&pageNo=${page.prevPage }"
								...
								<li class=" ${page.hasNext == true?"":"disabled"}"><a
									href="tradeServlet?method=toTradeUI&pageNo=${page.nextPage}"
									aria-label="Next"> <span aria-hidden="true">下一页&raquo;</span>
								</a></li>
								<li class=" ${page.hasNext == true?"":"disabled"}"><a
									href="tradeServlet?method=toTradeUI&pageNo=${page.totalPageNumber}">
